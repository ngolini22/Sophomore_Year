...
#define URL_PREFIX "www.cs.dartmouth.edu"
...
// Initializes all data structures and resources
...
// create global variables of data structures

int getPageCount; // is the file counter used to name the files appropriately in getPage
int url_listCount;
